...
jest.mock("../../config/forms", () => ({
  getFormDefinition: jest
    .fn()
    .mockReturnValue({ name: "Test Form", fields: [] }),
}));
...
describe("FormsController", () => {
  ...
  describe("createForm", () => {
    it("should create a form and return 201", async () => {
      ...
      (FormService.prototype.createForm as jest.Mock).mockResolvedValue(
        mockForm
      );
  ...
  describe("listForms", () => {
    it("should list forms", async () => {
      ...
      (FormService.prototype.listForms as jest.Mock).mockResolvedValue(
        mockResult
      );
  ...
  describe("getFormById", () => {
    it("should return form details", async () => {
      ...
      (FormService.prototype.getFormById as jest.Mock).mockResolvedValue(
        mockForm
      );
  ...
  describe("updateForm", () => {
    it("should update form", async () => {
      ...
      (FormService.prototype.updateForm as jest.Mock).mockResolvedValue(
        mockForm
      );
  ...
  describe("deleteForm", () => {
    it("should delete form", async () => {
      mockRequest.params = { id: "form-1" };
      (FormService.prototype.deleteForm as jest.Mock).mockResolvedValue(
        undefined
      );
  ...
  describe("submitForm", () => {
    it("should submit form", async () => {
      ...
      (FormService.prototype.submitForm as jest.Mock).mockResolvedValue(
        mockForm
      );
  ...
  describe("approveForm", () => {
    it("should approve form", async () => {
      ...
      (FormService.prototype.approveForm as jest.Mock).mockResolvedValue(
        mockForm
      );

      const next = jest.fn();
      formsController.approveForm(
        mockRequest as Request,
        mockResponse as Response,
        next
      );
